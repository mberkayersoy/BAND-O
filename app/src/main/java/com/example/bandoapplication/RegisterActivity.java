                ...
                .addOnCompleteListener(RegisterActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            hashMap.put("bio", "");
                            hashMap.put("imageurl", "https://firebasestorage.googleapis.com/v0/b/bando-application.appspot.com/o/person-placeholder.jpg?alt=media&token=071de68f-cb7f-414b-98e9-7a72a68db62a");
